import sys, json
sys.path.insert(0, str(MIGRATION_ROOT / "code/scripts"))
...
LIB = ROOT / "data/raw/benchmarks/raw/openroad_flow_scripts_sky130hd/da8f092a02a8e75658cc3100691aabff05f35629/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
