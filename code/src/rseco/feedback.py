...
ADDITIVE_WEIGHT_FIELDS: tuple[str, ...] = (
    ...
    # F6's second lever (codex lineage = the 0a behaviour baseline):
    # physical_penalty is raised together with boundary_penalty.
    "physical_penalty",
)
...
_FEEDBACK_RULES: tuple[tuple[FailureType, tuple[tuple[str, str], ...]], ...] = (
    ...
    (
        ...
        (
            ...
            ("physical_penalty", "increase_physical_penalty"),
        ),
    ),
)
