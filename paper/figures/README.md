...
| 图 4 | `fig4_cut_graph.png` | s-t split graph 示例（c17 N22 cone，901×607） | `data/cases/minimal/iscas85_c17_case01/cones/target_cone.json` | **已生成** (2026-08-03) |
| 图 5 | `fig5_failure_flow.png` | F1-F5 失败分类触发流程图（1247×584） | `paper/draft/method.md` §6 + `src/rseco/failures.py` | **已生成** (2026-08-03) |
