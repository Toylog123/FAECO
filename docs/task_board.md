...
| N31-05 | failure-aware ?????G/R/B ??????????? | done | P1 | `src/rseco/{gate_sizing,logic_rewrite,buffer_insertion}.py` + `scripts/run_hybrid_repair.py` + 4 ?????? | **G/R/B ??????????????2026-08-03?**?R?? family ?????? `lpflow_inputiso1p_1`?`or2_4`?+ B????? buffer ???????+ G?gate sizing?? OpenSTA ????????? WNS ????period 0.5ns rounds=6 ?? 4/4 ?????s27 -0.28?**-0.01**?s382 -0.94?**-0.80**?R/B ?? G ?????s420 -1.78?**-0.23**?s641 -1.86?**-0.36**?rounds=10 ?????B ? pre-layout ideal-net ?????????????????????????????final WNS?sta.log ????applied ????????? mapped_hybrid.v???????????????????? runner ???????accepted ??? inst+kind+to_type ??????/????????trial_id+round ????????????????`_mark_accepted` ??? + 3 ?????commit `692b0d6`+`a82ecf8`+`897cc74` ? push?audited ??? `experiments/20260803_sequential_hybrid_grb_r6_audited/`?A-only ???? |
